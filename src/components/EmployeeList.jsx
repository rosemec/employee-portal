...
import { useDeleteEmployeeMutation, useGetEmployeesQuery } from "../api-client";
...
const EmployeeList = () => {
  ...
  const [deleteEmployee, { isLoadingDelete }] = useDeleteEmployeeMutation();
  const downDelete = () => setDeletePop(false);
  const confirmDelete = () => {
    deleteEmployee(id);
    setDeletePop(false);
  };
  ...
  return (
    <>
      <div className="app">
        ...
        {deletePop ? (
          <DeletePopup downDelete={downDelete} confirmDelete={confirmDelete} />
        ) : (
